  ...
  return (
    <form action={addTodo}>
      <div className="flex items-center justify-center space-x-3">
        ...
        <button
          type="submit"
          className="px-4 py-2 text-sm font-medium text-center text-white bg-blue-400 rounded-lg cursor-pointer hover:bg-blue-600 focus:ring-4 focus:ring-blue-300"
        >
          追加
        </button>
      </div>
